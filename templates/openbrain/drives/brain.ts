...
export default new GitHubDrive({
  owner: env.BRAIN_GH_OWNER.describe("GitHub owner (user or org) of the repo backing this brain").toString(),
  repo: env.BRAIN_GH_REPO.describe("GitHub repo name backing this brain").toString(),
  branch: "main",
